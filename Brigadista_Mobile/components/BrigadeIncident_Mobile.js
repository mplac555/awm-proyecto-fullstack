...
const BrigadeIncident_Mobile=({navigation, route})=>{
  ...
  const SendReport = (e) =>{
    ...
    , carPlate: nplaca ,alertaIncident:type+' '+OtherText,alertaDescription: description };
    ...
    return(
        <View style={styles.container}>
            ...
            <Box style={styles.butonsPanel}>
                 <Button title="Enviar" style={styles.button}  backgroundColor ={'rgba(46,125,50,255)'}
                     onPress={SendReport}
                />
                
                <Button title="Cancelar" style={styles.button} backgroundColor ={'rgba(211,47,47,255)'}
