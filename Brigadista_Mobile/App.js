...
export default function App() {
  ...
  //Metodos
  const LoadBrig = (name, last, email, token) => {
    setNameB(name);
    setLastB(last);
    setMailB(email);
    setToken(token);
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen
          name="BrigadeLogin"
          component={BrigadeLogin}
          options={{ title: "Registro" }}
          initialParams={{ LoadBrig }}
        />
        <Stack.Screen
          name="BrigadeProfile_Mobile"
          component={BrigadeProfile_Mobile}
          options={{ title: "Pagina Principal" }}
        />
        <Stack.Screen
          name="BrigadeScan_Mobile"
          component={BrigadeScan_Mobile}
          options={{ title: "Scanaeo de Vehículo" }}
        />
        <Stack.Screen
          name="BrigadeIncident_Mobile"
          component={BrigadeIncident_Mobile}
          options={{ title: "Envio de Comentarios" }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
